...
# Originally from https://gist.github.com/Lekensteyn/6e0840e77bc9bd013f57
# Edited 28th June, 2018 by toru173
#
...
@contextmanager
def unxz(f_out):
    # EDIT by toru173: unxz not installed natively. Use gunzip
    proc = subprocess.Popen(["gunzip"], stdin=subprocess.PIPE, stdout=f_out)
    try:
        yield proc.stdin
    finally:
        proc.stdin.close()
